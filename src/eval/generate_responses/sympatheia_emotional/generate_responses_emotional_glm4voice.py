#!/usr/bin/env python3
"""
Generate audio responses from base GLM-4-Voice for empathy evaluation.
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Generate base GLM-4-Voice responses for empathy evaluation"
    )
    parser.add_argument(
...
def main():
    ...
    if todo:
        ...
        for idx, rec in enumerate(todo):
            ...
            prompt = build_prompt(user_tokens, PLAIN_SYSTEM_PROMPT)
